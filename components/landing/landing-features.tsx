...
const features = [
  {
    title: "Smart Payroll",
    description:
      "Automated tax calculations and direct deposits in just a few clicks.",
    icon: CreditCard,
  ...
  },
  {
    ...
    description:
      "Bank-grade encryption and granular access control for all data.",
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description:
      "Deep insights into company performance and employee turnover.",
    icon: BarChart3,
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            GoHRIS is equipped with everything you need to manage your team
            effectively, from hire to retire.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="mt-8 flex items-center text-sm font-semibold text-primary opacity-0 group-hover:opacity-100 translate-x-2.5 group-hover:translate-x-0 transition-all duration-300">
                Learn more
