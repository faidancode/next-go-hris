            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-muted-foreground text-sm max-w-xs mb-8">
                            The modern HR Operating System. Empowering teams with
                            intuitive payroll and workforce management tools.
                        </p>
                ...
                <div className="pt-10 border-t border-border flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-xs text-muted-foreground">
                        © {new Date().getFullYear()} GoHRIS Technologies Inc. All rights reserved.
                    </p>
                    <div className="flex items-center gap-2 text-xs text-muted-foreground">
                        Made with <Heart className="w-3 h-3 text-red-500 fill-red-500" /> in Southeast Asia
                    </div>
                </div>
            </div>
        </footer>
